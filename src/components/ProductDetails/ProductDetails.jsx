...
class ProductDetails extends Component {
  ...
  render() {
    ...
    let storage = ProductAllData["productDetails"][0]["storage"];
    ...
    var storageDiv = "d-none";
    if (storage != "na") {
      let storageArray = storage.split(",");
      var storageOption = storageArray.map((storageList, i) => {
        return <option value={storageList}> {storageList} </option>;
      });
      storageDiv = "";
    } else {
      storageDiv = "d-none";
              ...
              <Row>
                ...
                <Col className="p-3 " md={6} lg={6} sm={12} xs={12}>
                  ...
                  <div className={storageDiv}>
                    <h6 className="mt-2"> Choose storage </h6>
                    <select className="form-control form-select">
